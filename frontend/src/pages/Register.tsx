    ...
    <div className="min-h-screen bg-slate-900 text-white flex items-center justify-center p-4">
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 bg-slate-800/50 backdrop-blur-xl rounded-2xl p-8 border border-slate-700 shadow-2xl">
        ...
        <div className="space-y-6">
          ...
          <p className="text-slate-400">Join the platform to verify and earn.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  type="text" 
                  className="w-full bg-slate-900/50 border border-slate-700 rounded-lg py-2.5 pl-10 pr-4 focus:ring-2 focus:ring-blue-500 outline-none transition"
            ...
            <button 
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-bold py-3 rounded-lg transition-all transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? <Loader2 className="animate-spin" /> : 'Register with FaceID'}
            </button>
          </form>
        </div>
        ...
        <div className="flex flex-col items-center justify-center space-y-4 bg-black/20 rounded-xl p-4 border border-slate-700/50">
          <div className="relative w-full aspect-video rounded-lg overflow-hidden bg-black shadow-inner">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-64 border-2 border-dashed border-blue-400/50 rounded-full pointer-events-none"></div>
          </div>
